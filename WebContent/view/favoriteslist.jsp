          ...
          <div class="row gutters-sm">
              ...
              <div class="card mt-3">
                <div class="list-group list-group-flush"> 
                    ...
                    <a class="list-group-item active" href="favoriteslist.do"><i class="bi bi-heart-fill" style="margin-right: 10px;"></i>관심 목록<span class="badge badge-success">${cnt.like }</span></a>
