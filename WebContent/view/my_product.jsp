          ...
          <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                <div class="list-group list-group-flush"> 
                    ...
                    <a class="list-group-item active " href="my_product.do"> <i class="bi bi-bag-plus" style="margin-right: 10px;"></i>판매 물품 관리<span class="badge badge-success">3</span></a>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                ...
                <div class="btn btn-success" style="float: right;" onclick="location.href='productAdd.do'">물품 등록</div>
